...
import { Mail, Lock, User, Eye, EyeOff, ArrowLeft, Loader2, ShieldCheck } from 'lucide-react';
          ...
          {mfaRequired ? (
            ...
            <>
              ...
              <div className="relative flex items-center my-6">
                ...
                <span className="px-4 text-sm text-ink-faint">or use email</span>
                <div className="flex-1 border-t border-line" />
              </div>
              ...
              <motion.form {...formMotion} onSubmit={handleEmailSubmit} className="space-y-4">
                {isSignUp && (
                  <div>
