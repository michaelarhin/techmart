...
const NotFound = () => (
  <div className="min-h-screen pt-28 pb-16 flex items-center justify-center px-4">
    <motion.div variants={fadeUp} initial="hidden" animate="show" className="surface rounded-4xl p-10 sm:p-14 text-center max-w-lg">
      <span className="w-16 h-16 mx-auto rounded-2xl surface-muted grid place-items-center text-navy-600 mb-6">
        <Compass className="w-8 h-8" />
      </span>
      <p className="text-6xl font-extrabold text-ink tracking-tight">404</p>
      <h1 className="text-2xl font-extrabold text-ink mt-3">This page wandered off</h1>
